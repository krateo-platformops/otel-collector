...
[`krateo-clickstack-chart`](https://github.com/krateo-platformops/clickstack-chart).
...
## Build & release
Image: `ghcr.io/krateo-platformops/otel-collector`. Pushing a semver tag (`X.Y.Z`) builds and
